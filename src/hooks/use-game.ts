...
//   const { updateTeams, updateGames } = useFirebase();
...
//     await updateGames(allGames.value);
...
//     await updateTeams(allTeams.value);
...
//   ) => {
//     allGames.value = allGames.value.map((game: Game) => {
//       if (game?.id === gameId) {
